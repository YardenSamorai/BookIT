...
const compareSections: CompareSection[] = [
  {
    ...
    rows: [
      ...
      { key: "landing.compare_ai_insights", starter: true, pro: true },
      { key: "landing.compare_ai_chat", starter: false, pro: true },
      { key: "landing.compare_recurring", starter: true, pro: true },
      { key: "landing.compare_cancel_policy", starter: true, pro: true },
      { key: "landing.compare_intake_forms", starter: true, pro: true },
      { key: "landing.compare_products", starter: true, pro: true },
      { key: "landing.compare_shop_cart", starter: true, pro: true },
